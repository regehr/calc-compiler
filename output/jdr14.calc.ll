...
entry:
  ...
  %6 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 1, i64 1)
  %7 = extractvalue { i64, i1 } %6, 0
  %8 = extractvalue { i64, i1 } %6, 1
  br i1 %8, label %then, label %else

then:                                             ; preds = %entry
  %calltrap = call i64 @overflow_fail(i64 33)
  br label %else

else:                                             ; preds = %then, %entry
  %9 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %7, i64 1)
  %10 = extractvalue { i64, i1 } %9, 0
  %11 = extractvalue { i64, i1 } %9, 1
  br i1 %11, label %then1, label %else3

then1:                                            ; preds = %else
  %calltrap2 = call i64 @overflow_fail(i64 30)
  br label %else3

else3:                                            ; preds = %then1, %else
  %12 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %0, i64 %10)
  %13 = extractvalue { i64, i1 } %12, 0
  %14 = extractvalue { i64, i1 } %12, 1
  br i1 %14, label %then4, label %else6

then4:                                            ; preds = %else3
  %calltrap5 = call i64 @overflow_fail(i64 24)
  br label %else6
...
then7:                                            ; preds = %else6
  %calltrap8 = call i64 @overflow_fail(i64 21)
  br label %else9
