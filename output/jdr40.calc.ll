...
then:                                             ; preds = %whileBody2
  %calltrap = call i64 @overflow_fail(i64 259)
  br label %else
...
then6:                                            ; preds = %else
  %calltrap7 = call i64 @overflow_fail(i64 278)
  br label %else8
...
then9:                                            ; preds = %else8
  %calltrap10 = call i64 @overflow_fail(i64 272)
  br label %else11

else11:                                           ; preds = %then9, %else8
  %27 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %25, i64 24)
  %28 = extractvalue { i64, i1 } %27, 0
  %29 = extractvalue { i64, i1 } %27, 1
  br i1 %29, label %then12, label %else14

then12:                                           ; preds = %else11
  %calltrap13 = call i64 @overflow_fail(i64 269)
  br label %else14
...
then18:                                           ; preds = %merge
  %calltrap19 = call i64 @overflow_fail(i64 248)
  br label %else20
...
then21:                                           ; preds = %else20
  %calltrap22 = call i64 @overflow_fail(i64 328)
  br label %else23
...
then24:                                           ; preds = %whileExit3
  %calltrap25 = call i64 @overflow_fail(i64 362)
  br label %else26
