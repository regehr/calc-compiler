...
then:                                             ; preds = %entry
  %calltrap = call i64 @overflow_fail(i64 28)
  br label %else
...
then1:                                            ; preds = %else
  %calltrap2 = call i64 @overflow_fail(i64 39)
  br label %else3
...
then4:                                            ; preds = %else3
  %calltrap5 = call i64 @overflow_fail(i64 36)
  br label %else6
...
then7:                                            ; preds = %else6
  %calltrap8 = call i64 @overflow_fail(i64 25)
  br label %else9
...
then10:                                           ; preds = %else9
  %calltrap11 = call i64 @overflow_fail(i64 22)
  br label %else12
