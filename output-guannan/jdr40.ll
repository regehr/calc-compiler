; (seq (while (!= m0 a0) (seq (while (!= m1 a0) (seq (set (+ (if (== (* m1 m1) (- (* m0 (* m0 m0)) 24)) 1 0) m2) m2) (set (+ 1 m1) m1))) (seq (set (+ 1 m0) m0) (set 0 m1)))) m2)
; ModuleID = 'calc'
...
normal18:                                         ; preds = %of17, %normal12
  ...
  %result25 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %add22, i64 24)
