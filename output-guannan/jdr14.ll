...
entry:
  ...
  %m9 = alloca i64
  store i64 0, i64* %m9
  %result = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 1, i64 1)
...
normal:                                           ; preds = %of, %entry
  ...
  %result3 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %add, i64 1)
