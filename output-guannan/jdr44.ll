; (seq (while (!= m0 a0) (seq (while (!= m1 a0) (seq (set (+ (if (== (* m1 m1) (- (* m0 (* m0 m0)) 4)) 1 0) m9) m9) (set (+ 1 m1) m1))) (seq (set (+ 1 m0) m0) (set 0 m1)))) m9)
; ModuleID = 'calc'
...
normal18:                                         ; preds = %of17, %normal12
  ...
  %result25 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %add22, i64 4)
...
ifcont:                                           ; preds = %else, %then
  ...
  %m929 = load i64, i64* %m9
  %result32 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %iftmp, i64 %m929)
...
of46:                                             ; preds = %cont3
  call void @overflow_fail(i32 368)
  br label %normal47
