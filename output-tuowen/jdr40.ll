...
over4:                                            ; preds = %safe
  tail call void @overflow_fail(i64 278)
  unreachable
...
over6:                                            ; preds = %safe5
  tail call void @overflow_fail(i64 272)
  unreachable

safe7:                                            ; preds = %safe5
  %27 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %25, i64 24)
...
over14:                                           ; preds = %AfterW3
  tail call void @overflow_fail(i64 362)
  unreachable
