...
; <label>:9:                                      ; preds = %entry
  %10 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %4, i64 %7)
...
; <label>:14:                                     ; preds = %9
  %15 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %3, i64 %11)
...
; <label>:19:                                     ; preds = %14
  %20 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %2, i64 %16)
...
; <label>:24:                                     ; preds = %19
  %25 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %1, i64 %21)
