...
; <label>:41:                                     ; preds = %22
  call void @overflow_fail(i32 83)
  unreachable
...
; <label>:64:                                     ; preds = %42
  call void @overflow_fail(i32 130)
  unreachable
...
; <label>:89:                                     ; preds = %67
  call void @overflow_fail(i32 191)
  unreachable
...
; <label>:154:                                    ; preds = %132
  call void @overflow_fail(i32 355)
  unreachable
...
; <label>:194:                                    ; preds = %172
  call void @overflow_fail(i32 458)
  unreachable
...
; <label>:239:                                    ; preds = %217
  call void @overflow_fail(i32 575)
  unreachable
...
; <label>:289:                                    ; preds = %267
  call void @overflow_fail(i32 706)
  unreachable
...
; <label>:344:                                    ; preds = %322
  call void @overflow_fail(i32 853)
  unreachable
...
; <label>:404:                                    ; preds = %382
  call void @overflow_fail(i32 1015)
  unreachable
...
; <label>:469:                                    ; preds = %447
  call void @overflow_fail(i32 1192)
  unreachable
...
; <label>:539:                                    ; preds = %517
  call void @overflow_fail(i32 1384)
  unreachable
...
; <label>:614:                                    ; preds = %592
  call void @overflow_fail(i32 1591)
  unreachable
...
; <label>:694:                                    ; preds = %672
  call void @overflow_fail(i32 1813)
  unreachable
...
; <label>:779:                                    ; preds = %757
  call void @overflow_fail(i32 2050)
  unreachable
...
; <label>:869:                                    ; preds = %847
  call void @overflow_fail(i32 2302)
  unreachable
...
; <label>:964:                                    ; preds = %942
  call void @overflow_fail(i32 2569)
  unreachable
...
; <label>:1064:                                   ; preds = %1042
  call void @overflow_fail(i32 2851)
  unreachable
...
; <label>:1168:                                   ; preds = %1147
  call void @overflow_fail(i32 3148)
  unreachable
