...
; <label>:41:                                     ; preds = %22
  call void @overflow_fail(i32 72)
  unreachable
...
; <label>:381:                                    ; preds = %375
  call void @overflow_fail(i32 801)
  unreachable
...
; <label>:446:                                    ; preds = %440
  call void @overflow_fail(i32 957)
  unreachable
...
; <label>:516:                                    ; preds = %510
  call void @overflow_fail(i32 1128)
  unreachable
...
; <label>:591:                                    ; preds = %585
  call void @overflow_fail(i32 1314)
  unreachable
...
; <label>:671:                                    ; preds = %665
  call void @overflow_fail(i32 1515)
  unreachable
...
; <label>:756:                                    ; preds = %750
  call void @overflow_fail(i32 1731)
  unreachable
...
; <label>:846:                                    ; preds = %840
  call void @overflow_fail(i32 1962)
  unreachable
...
; <label>:941:                                    ; preds = %935
  call void @overflow_fail(i32 2208)
  unreachable
...
; <label>:1041:                                   ; preds = %1035
  call void @overflow_fail(i32 2469)
  unreachable
...
; <label>:1146:                                   ; preds = %1140
  call void @overflow_fail(i32 2745)
  unreachable
...
; <label>:1255:                                   ; preds = %1249
  call void @overflow_fail(i32 3036)
  unreachable
}
