...
; <label>:41:                                     ; preds = %22
  call void @overflow_fail(i32 74)
  unreachable
...
; <label>:64:                                     ; preds = %42
  call void @overflow_fail(i32 121)
  unreachable
...
; <label>:89:                                     ; preds = %67
  call void @overflow_fail(i32 182)
  unreachable
...
; <label>:119:                                    ; preds = %97
  call void @overflow_fail(i32 257)
  unreachable
...
; <label>:154:                                    ; preds = %132
  call void @overflow_fail(i32 346)
  unreachable
...
; <label>:194:                                    ; preds = %172
  call void @overflow_fail(i32 449)
  unreachable
...
; <label>:239:                                    ; preds = %217
  call void @overflow_fail(i32 566)
  unreachable
...
; <label>:289:                                    ; preds = %267
  call void @overflow_fail(i32 697)
  unreachable
...
; <label>:344:                                    ; preds = %322
  call void @overflow_fail(i32 844)
  unreachable
...
; <label>:404:                                    ; preds = %382
  call void @overflow_fail(i32 1006)
  unreachable
...
; <label>:469:                                    ; preds = %447
  call void @overflow_fail(i32 1183)
  unreachable
...
; <label>:539:                                    ; preds = %517
  call void @overflow_fail(i32 1375)
  unreachable
...
; <label>:614:                                    ; preds = %592
  call void @overflow_fail(i32 1582)
  unreachable
...
; <label>:694:                                    ; preds = %672
  call void @overflow_fail(i32 1804)
  unreachable
...
; <label>:779:                                    ; preds = %757
  call void @overflow_fail(i32 2041)
  unreachable
...
; <label>:869:                                    ; preds = %847
  call void @overflow_fail(i32 2293)
  unreachable
...
; <label>:964:                                    ; preds = %942
  call void @overflow_fail(i32 2560)
  unreachable
...
; <label>:1064:                                   ; preds = %1042
  call void @overflow_fail(i32 2842)
  unreachable
...
; <label>:1168:                                   ; preds = %1147
  call void @overflow_fail(i32 3139)
  unreachable
